...
import { fetchNotes, createNote, updateNote, deleteNote } from '../services/api.js'
    ...
    <>
      ...
      <main className='flex flex-col items-center p-6'>
        <div className='w-2/4 flex flex-col'>
          ...
          ></textarea>
          <button
          className='m-4 mr-0 border p-4 border-black self-end hover:bg-gray-100 rounded-lg'
